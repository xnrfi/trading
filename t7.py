...
async def get_lighter_account_values(l1_address: str = None):
    ...
    try:
        # Correct SignerClient constructor as used in your working bot script (api_private_keys dict)
        ...
        if err is not None:
            ...
            print("Check your API_KEY_PRIVATE_KEY, API_KEY_INDEX, and MAIN_ACCOUNT_INDEX")
            return
