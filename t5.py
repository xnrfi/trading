...
async def get_lighter_account_values(l1_address: str = None):
    ...
    try:
        # Create SignerClient using the correct current parameter: api_private_keys as dict
        ...
        if err is not None:
            ...
            print("Verify your API_KEY_PRIVATE_KEY, API_KEY_INDEX, and MAIN_ACCOUNT_INDEX")
            return
